...
chiion = np.array([6, 12, 51, 67]) #Rounded values of Ca
...
plt.ylabel(r'Ca II K / H$\alpha$', size=18)
plt.legend(fontsize=18)
plt.savefig('strengthratioCaK')
plt.show()
"""
...
plt.savefig('temperaturesensitivity')
plt.show()
"""
...
print 'Where 50% ionized:', temp[98]
plt.plot(temp,nH)
plt.xlabel('temperature $T/K$', size=18)
plt.ylabel('neutral hydrogen fraction', size=18)
plt.savefig('hotvscool')
plt.show()
